...
abstract public class FloodProtection {
	...
	public enum Metric {
		SINGLE ("getCostEffectiveness"), 
		SUBBASIN ("getSubbasinCostEffectiveness"), 
		WHOLE ("getWholeBasinCostEffectiveness");
		
		private final String method;
		
		Metric(String method) {
			this.method = method;
		}
	...
	public String toString() {
		return this.getClass().getSimpleName() + "[capacity=" + capacity
				+ ",cost=" + getCost() + ",segment=" + segment.getName()
				+ ", payer=" + payer.getName() + "]";
	}
}